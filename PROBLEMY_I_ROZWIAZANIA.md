...
```bash
curl -X POST "https://elektron-finance.preview.emergentagent.com/api/ai/chat" \
...
```bash
curl "https://elektron-finance.preview.emergentagent.com/api/ai/sessions"
# Powinno zwrócić listę sesji JSON
```

### Test 3: AI Analityk GPT-5 - Backend
```bash
curl "https://elektron-finance.preview.emergentagent.com/api/ai-analyst/chat/sessions"
# Powinno zwrócić listę sesji JSON
```
