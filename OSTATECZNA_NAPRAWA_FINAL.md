...
```
Firefox → https://elektron-hub.preview.emergentagent.com
```
...
```bash
curl https://elektron-hub.preview.emergentagent.com/api/ai/sessions?limit=5
# Zwraca 5 sesji ✅

curl https://elektron-hub.preview.emergentagent.com/api/ai-analyst/chat/sessions?limit=5
# Zwraca 5 sesji ✅
```
